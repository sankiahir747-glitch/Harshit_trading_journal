...
# ==========================================
# NATIVE DATAFRAME BUILDER FOR SAFE RENDERING
# ==========================================
def fetch_dataframe_styled(symbols_dict):
    rows = []
...
# ==========================================
# 3. GLOBAL MARKETS (SAFE STREAMLIT DATAFRAME)
# ==========================================
with tab_global_mkt:
    ...
    df_us = fetch_dataframe_styled(us_dict)
    if not df_us.empty:
    ...
    df_eu = fetch_dataframe_styled(eu_dict)
    if not df_eu.empty:
    ...
    df_asia = fetch_dataframe_styled(asia_dict)
...
with tab_futures_etfs:
    ...
    df_fut = fetch_dataframe_styled(futures_dict)
    if not df_fut.empty:
    ...
    df_etf = fetch_dataframe_styled(etf_dict)
    if not df_etf.empty:
