...
# AUTOMATIC SMOOTH AUTO-REFRESH (Set to 30 Seconds - Zero Glitch)
try:
    from streamlit_autorefresh import st_autorefresh
    st_autorefresh(interval=30000, key="indices_live_stream_30s")
except Exception:
    pass
...
with col_status:
    ...
    if st.button("🔄 Refresh Ticker Now", use_container_width=True):
        st.rerun()

# FAST REAL-TIME DERIVATIVE INDEX TICKER
