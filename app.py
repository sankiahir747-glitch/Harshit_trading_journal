...
# ULTRA-CLEAN LIGHT THEME WITH HIGHLIGHTED NAVIGATION TABS
st.markdown("""
    <style>
    .stApp {
...
# ==========================================
# BULLETPROOF SAFE DATAFRAME BUILDER (NO CRASH)
# ==========================================
    ...
    for name, sym in symbols_dict.items():
        try:
            ...
            if len(hist) >= 2:
                ...
                # Format Green/Red indicator symbols directly in string for 100% safety
...
# ==========================================
# 3. GLOBAL MARKETS (WITH COLOR INDICATORS & ASIAN MARKETS)
# ==========================================
with tab_global_mkt:
