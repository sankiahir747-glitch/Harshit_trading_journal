...
# AUTOMATIC FAST REFRESH FOR TOP DERIVATIVE INDEXES STREAM (2 Seconds)
try:
    from streamlit_autorefresh import st_autorefresh
    st_autorefresh(interval=2000, key="indices_live_stream_refresher")
except Exception:
    pass
...
# ==========================================
# 4. HEAVYWEIGHTS (FIXED DATAFRAME FORMATTING - IMAGE 2 RESOLVED)
# ==========================================
with tab_components:
...
# ==========================================
# 5. SECTOR PERFORMANCE (ALL 17 SECTORS - IMAGE 3 FIXED)
# ==========================================
with tab_sector:
