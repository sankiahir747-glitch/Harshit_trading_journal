...
# ULTRA-CLEAN HIGH CONTRAST LIGHT THEME (No Dark Text Blending Issues)
st.markdown("""
    <style>
    .stApp {
...
with tab_analytics:
    ...
    if df.empty:
        ...
        # Display Sample Preview Cards so user sees the 35+ metrics suite instantly
        ...
        st.markdown("---")
        st.markdown("#### 🛠️ Included 35+ Performance & Risk Analytics Metrics:")
        u1, u2, u3 = st.columns(3)
        with u1:
            st.markdown("* **1. Realized Net P&L**\n* **2. Gross P&L**\n* **3. Total Charges Breakdown**\n* **4. Win Rate %**\n* **5. Loss Rate %**\n* **6. Profit Factor**\n* **7. Trade Expectancy**\n* **8. Payoff Ratio**\n* **9. Average Win Amount**\n* **10. Average Loss Amount**\n* **11. Max Consecutive Wins**\n* **12. Max Consecutive Losses**")
        with u2:
            st.markdown("* **13. Equity Curve Growth**\n* **14. Max Drawdown (₹)**\n* **15. Max Drawdown (%)**\n* **16. Sharpe Ratio**\n* **17. Risk-Reward Ratio Average**\n* **18. Best Single Trade**\n* **19. Worst Single Trade**\n* **20. Long (BUY) Win Rate**\n* **21. Short (SELL) Win Rate**\n* **22. Market Type Split P&L**\n* **23. Daily P&L Heatmap**\n* **24. Monthly P&L Summary**")
        with u3:
            st.markdown("* **25. P&L by Emotional State**\n* **26. Mistakes Cost Analysis**\n* **27. Strategy Accuracy %**\n* **28. Commission Leakage %**\n* **29. Daily Drawdown Tracker**\n* **30. Average Hold Duration**\n* **31. Risk Per Trade Tracker**\n* **32. Target Hit Accuracy**\n* **33. Stop-Loss Trigger Rate**\n* **34. Position Size Efficiency**\n* **35. AI Pattern Insights**")
    else:
        tot_t = len(df)
